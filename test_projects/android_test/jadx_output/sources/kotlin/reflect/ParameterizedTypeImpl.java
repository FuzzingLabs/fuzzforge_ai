...
public final class ParameterizedTypeImpl implements ParameterizedType, TypeImpl {
    ...
    public String getTypeName() {
        ...
        if (!(typeArr.length == 0)) {
            ArraysKt.joinTo$default(typeArr, $this$buildString, (CharSequence) null, "<", ">", 0, (CharSequence) null, ParameterizedTypeImpl$getTypeName$1$1.INSTANCE, 50, (Object) null);
        }
