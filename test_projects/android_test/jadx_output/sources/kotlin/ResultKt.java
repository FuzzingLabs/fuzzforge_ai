...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            ...
            return Result.m294constructorimpl(function0.invoke());
        } catch (Throwable e) {
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m294constructorimpl(function1.invoke(t));
        } catch (Throwable e) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m294constructorimpl(createFailure(e));
        }
    ...
    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> function1) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m294constructorimpl(function1.invoke($this$map));
    }
    ...
    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> function1) {
        if (Result.m301isSuccessimpl($this$mapCatching)) {
            try {
                Result.Companion companion = Result.INSTANCE;
                Object $this$runCatching = Result.m294constructorimpl(function1.invoke($this$mapCatching));
    ...
    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> function1) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m294constructorimpl(function1.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> function1) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            Object $this$runCatching = Result.m294constructorimpl(function1.invoke(exception));
            return $this$runCatching;
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m294constructorimpl(createFailure(th));
