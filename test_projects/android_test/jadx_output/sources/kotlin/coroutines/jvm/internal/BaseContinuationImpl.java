    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                m294constructorimpl = Result.m294constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            m294constructorimpl = Result.m294constructorimpl(outcome);
            Object outcome2 = m294constructorimpl;
