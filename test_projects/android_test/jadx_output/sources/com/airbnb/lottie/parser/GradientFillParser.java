...
public class GradientFillParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m16of("nm", "g", "o", "t", "s", "e", "r", "hd");
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static GradientFill parse(JsonReader reader, LottieComposition composition) throws IOException {
        String name = null;
