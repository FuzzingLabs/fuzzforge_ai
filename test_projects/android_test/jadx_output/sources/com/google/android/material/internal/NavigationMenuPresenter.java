...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public void initForMenu(Context context, MenuBuilder menu) {
        ...
        this.paddingSeparator = res.getDimensionPixelOffset(C0690R.dimen.design_navigation_separator_vertical_padding);
    }

    @Override // androidx.appcompat.view.menu.MenuPresenter
    public MenuView getMenuView(ViewGroup root) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(C0690R.layout.design_navigation_menu, root, false);
            ...
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C0690R.layout.design_navigation_item_header, (ViewGroup) this.menuView, false);
    ...
    public static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater inflater, ViewGroup parent, View.OnClickListener listener) {
            super(inflater.inflate(C0690R.layout.design_navigation_item, parent, false));
    ...
    public static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(C0690R.layout.design_navigation_item_subheader, parent, false));
        }
    }
    ...
    public static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(C0690R.layout.design_navigation_item_separator, parent, false));
        }
    }
