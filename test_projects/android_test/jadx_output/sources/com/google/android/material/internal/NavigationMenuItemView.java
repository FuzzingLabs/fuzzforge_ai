...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0690R.layout.design_navigation_menu_item, (ViewGroup) this, true);
        setIconSize(context.getResources().getDimensionPixelSize(C0690R.dimen.design_navigation_icon_size));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(C0690R.id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0690R.id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (getContext().getTheme().resolveAttribute(C0046R.attr.colorControlHighlight, value, true)) {
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable drawable = ResourcesCompat.getDrawable(getResources(), C0690R.drawable.navigation_empty_icon, getContext().getTheme());
