...
public class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0690R.styleable.ClockHandView, defStyleAttr, C0690R.style.Widget_MaterialComponents_TimePicker_Clock);
        this.circleRadius = a.getDimensionPixelSize(C0690R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = a.getDimensionPixelSize(C0690R.styleable.ClockHandView_selectorSize, 0);
        Resources res = getResources();
        this.selectorStrokeWidth = res.getDimensionPixelSize(C0690R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = res.getDimensionPixelSize(C0690R.dimen.material_clock_hand_center_dot_radius);
        int selectorColor = a.getColor(C0690R.styleable.ClockHandView_clockHandColor, 0);
