...
public class MaterialThemeOverlay {
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {R.attr.theme, C0690R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C0690R.attr.materialThemeOverlay};
