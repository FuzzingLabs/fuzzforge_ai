...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        int maximumDefaultFullscreenMinorAxis = res.getDimensionPixelSize(C0690R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis);
        int minorAxisPx = Math.min(display.widthPixels, display.heightPixels);
        int defaultThemeAttr = minorAxisPx > maximumDefaultFullscreenMinorAxis ? C0690R.attr.materialCalendarTheme : C0690R.attr.materialCalendarFullscreenTheme;
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return res.getString(C0690R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return res.getString(C0690R.string.mtrl_picker_range_header_only_start_selected, DateStrings.getDateString(this.selectedStartItem.longValue()));
        }
        if (l == null) {
            return res.getString(C0690R.string.mtrl_picker_range_header_only_end_selected, DateStrings.getDateString(this.selectedEndItem.longValue()));
        }
        Pair<String, String> dateRangeStrings = DateStrings.getDateRangeString(l, l2);
        return res.getString(C0690R.string.mtrl_picker_range_header_selected, dateRangeStrings.first, dateRangeStrings.second);
    }

    @Override // com.google.android.material.datepicker.DateSelector
    public int getDefaultTitleResId() {
        return C0690R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, final OnSelectionChangedListener<Pair<Long, Long>> listener) {
        View root = layoutInflater.inflate(C0690R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        final TextInputLayout startTextInput = (TextInputLayout) root.findViewById(C0690R.id.mtrl_picker_text_input_range_start);
        final TextInputLayout endTextInput = (TextInputLayout) root.findViewById(C0690R.id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = root.getResources().getString(C0690R.string.mtrl_picker_invalid_range);
