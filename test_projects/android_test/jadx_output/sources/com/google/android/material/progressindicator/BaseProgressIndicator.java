...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    static final int DEF_STYLE_RES = C0690R.style.Widget_MaterialComponents_ProgressIndicator;
    ...
    public BaseProgressIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0690R.styleable.BaseProgressIndicator, defStyleAttr, defStyleRes, new int[0]);
        this.showDelay = a.getInt(C0690R.styleable.BaseProgressIndicator_showDelay, -1);
        int minHideDelayUncapped = a.getInt(C0690R.styleable.BaseProgressIndicator_minHideDelay, -1);
    ...
    public void setIndicatorColor(int... indicatorColors) {
        if (indicatorColors.length == 0) {
            indicatorColors = new int[]{MaterialColors.getColor(getContext(), C0690R.attr.colorPrimary, -1)};
        }
