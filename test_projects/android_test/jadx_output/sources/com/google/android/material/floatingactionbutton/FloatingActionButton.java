...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C0690R.style.Widget_Design_FloatingActionButton;
    ...
    public FloatingActionButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0690R.attr.floatingActionButtonStyle);
    }
    ...
    */
    ...
    private int getSizeDimension(int size) {
        ...
        switch (size) {
            ...
            case 0:
            default:
                return res.getDimensionPixelSize(C0690R.dimen.design_fab_size_normal);
            case 1:
                return res.getDimensionPixelSize(C0690R.dimen.design_fab_size_mini);
        }
    }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0690R.styleable.FloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = a.getBoolean(C0690R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
            a.recycle();
        }
