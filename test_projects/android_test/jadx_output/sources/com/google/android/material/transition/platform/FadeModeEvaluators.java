...
class FadeModeEvaluators {
    ...
    /* renamed from: IN */
    private static final FadeModeEvaluator f152IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.platform.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int fadeMode, boolean entering) {
        switch (fadeMode) {
            case 0:
                return entering ? f152IN : OUT;
            case 1:
                return entering ? OUT : f152IN;
            case 2:
                return CROSS;
            case 3:
                return THROUGH;
