...
class FadeModeEvaluators {
    ...
    /* renamed from: IN */
    private static final FadeModeEvaluator f148IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int fadeMode, boolean entering) {
        switch (fadeMode) {
            case 0:
                return entering ? f148IN : OUT;
            case 1:
                return entering ? OUT : f148IN;
            case 2:
                return CROSS;
            case 3:
                return THROUGH;
