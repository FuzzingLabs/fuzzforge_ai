...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    private static final int DEF_STYLE_RES = C0690R.style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    ...
    public MaterialStyledDatePickerDialog(Context context, int themeResId, DatePickerDialog.OnDateSetListener listener, int year, int monthOfYear, int dayOfMonth) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(getContext(), C0690R.attr.colorSurface, getClass().getCanonicalName());
        int i = DEF_STYLE_RES;
