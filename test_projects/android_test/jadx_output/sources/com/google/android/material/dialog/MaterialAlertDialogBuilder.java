...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C0690R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0690R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0690R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int overrideThemeResId) {
        ...
        int surfaceColor = MaterialColors.getColor(context2, C0690R.attr.colorSurface, getClass().getCanonicalName());
