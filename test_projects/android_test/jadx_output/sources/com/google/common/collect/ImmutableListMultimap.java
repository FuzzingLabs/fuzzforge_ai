...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    ...
    public static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> toImmutableListMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda8
            @Override // java.util.function.Supplier
            public final Object get() {
                return ImmutableListMultimap.builder();
            }
        }, new BiConsumer() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda0
        ...
        }, new BinaryOperator() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda1
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                return ((ImmutableListMultimap.Builder) obj).combine((ImmutableMultimap.Builder) obj2);
            }
        }, new Function() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda5
    ...
    public static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> flatteningToImmutableListMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends Stream<? extends V>> valuesFunction) {
        ...
        Function function = new Function() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda3
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Object checkNotNull;
        ...
        Function function2 = new Function() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda4
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Stream peek;
        ...
        return Collectors.collectingAndThen(Multimaps.flatteningToMultimap(function, function2, new Supplier() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda7
            @Override // java.util.function.Supplier
            public final Object get() {
                return MultimapBuilder.ListMultimapBuilder.this.build();
            }
        }), new Function() { // from class: com.google.common.collect.ImmutableListMultimap$$ExternalSyntheticLambda6
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m86of() {
        return EmptyImmutableListMultimap.INSTANCE;
    }

    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m87of(K k1, V v1) {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m88of(K k1, V v1, K k2, V v2) {
        Builder<K, V> builder = builder();
        builder.put((Builder<K, V>) k1, (K) v1);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m89of(K k1, V v1, K k2, V v2, K k3, V v3) {
        Builder<K, V> builder = builder();
        builder.put((Builder<K, V>) k1, (K) v1);
        builder.put((Builder<K, V>) k2, (K) v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m90of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        Builder<K, V> builder = builder();
        builder.put((Builder<K, V>) k1, (K) v1);
        builder.put((Builder<K, V>) k2, (K) v2);
        builder.put((Builder<K, V>) k3, (K) v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m91of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        Builder<K, V> builder = builder();
        builder.put((Builder<K, V>) k1, (K) v1);
        builder.put((Builder<K, V>) k2, (K) v2);
        builder.put((Builder<K, V>) k3, (K) v3);
    ...
    public ImmutableList<V> get(K key) {
        ...
        return list == null ? ImmutableList.m73of() : list;
    }
