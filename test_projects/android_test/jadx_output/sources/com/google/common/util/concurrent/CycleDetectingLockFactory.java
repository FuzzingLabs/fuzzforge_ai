...
public class CycleDetectingLockFactory {
    ...
    private static Map<? extends Enum, LockGraphNode> getOrCreateNodes(Class<? extends Enum> clazz) {
        ...
        Map<? extends Enum, LockGraphNode> existing = concurrentMap.get(clazz);
        if (existing != null) {
            return existing;
        }
        Map<? extends Enum, LockGraphNode> created = createNodes(clazz);
        return (Map) MoreObjects.firstNonNull(concurrentMap.putIfAbsent(clazz, created), created);
    }
    ...
    public static class ExampleStackTrace extends IllegalStateException {
        ...
        static final ImmutableSet<String> EXCLUDED_CLASS_NAMES = ImmutableSet.m119of(CycleDetectingLockFactory.class.getName(), ExampleStackTrace.class.getName(), LockGraphNode.class.getName());
