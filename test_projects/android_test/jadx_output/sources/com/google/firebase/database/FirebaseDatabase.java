...
public class FirebaseDatabase {
    ...
    private final FirebaseApp f294app;
    ...
    public static FirebaseDatabase createForTests(FirebaseApp app2, RepoInfo repoInfo, DatabaseConfig config) {
        FirebaseDatabase db = new FirebaseDatabase(app2, repoInfo, config);
        db.ensureRepo();
        return db;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public FirebaseDatabase(FirebaseApp app2, RepoInfo repoInfo, DatabaseConfig config) {
        this.f294app = app2;
