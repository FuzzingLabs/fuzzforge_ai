...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ImageView iconRefine = (ImageView) v.findViewById(C0046R.id.edit_query);
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0046R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0046R.attr.textColorSearchUrl, colorValue, true);
