...
public class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0046R.styleable.AlertDialog, C0046R.attr.alertDialogStyle, 0);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:59:0x009f, code lost:
        ...
        r1 = r9.findViewById(androidx.appcompat.C0046R.id.titleDividerNoCustom);
     */
    /*
    ...
    */
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0046R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0046R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0046R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0046R.id.title_template);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0046R.id.title_template);
