...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0046R.id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0046R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0046R.id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) decor.findViewById(C0046R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0046R.styleable.ActionBar, C0046R.attr.actionBarStyle, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            currentTheme.resolveAttribute(C0046R.attr.actionBarWidgetTheme, outValue, true);
