...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false, C0046R.attr.popupMenuStyle, 0);
    }
    ...
    private MenuPopup createPopup() {
        ...
        int minSmallestWidthCascading = this.mContext.getResources().getDimensionPixelSize(C0046R.dimen.abc_cascading_menus_min_smallest_width);
