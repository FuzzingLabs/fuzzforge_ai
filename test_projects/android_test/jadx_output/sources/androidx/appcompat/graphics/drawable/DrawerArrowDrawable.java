...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0046R.styleable.DrawerArrowToggle, C0046R.attr.drawerArrowStyle, C0046R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        ...
        setGapSize(Math.round(a.getDimension(C0046R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0046R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = Math.round(a.getDimension(C0046R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = Math.round(a.getDimension(C0046R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
