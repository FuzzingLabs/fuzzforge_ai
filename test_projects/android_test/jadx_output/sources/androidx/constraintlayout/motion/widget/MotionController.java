...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f55x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f56y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f55x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f56y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f55x;
        start.top = this.mStartMotionPath.f56y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f55x;
        end.top = this.mEndMotionPath.f56y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f55x - this.mStartMotionPath.f55x;
        float dy = this.mEndMotionPath.f56y - this.mStartMotionPath.f56y;
        float startCenterX = this.mStartMotionPath.f55x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f56y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (points[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                ...
                values[i9][0] = points[i9].f55x;
                values[i9][1] = points[i9].f56y;
            }
    ...
    public String toString() {
        float f = this.mStartMotionPath.f55x;
        float f2 = this.mStartMotionPath.f56y;
        float f3 = this.mEndMotionPath.f55x;
        float f4 = this.mEndMotionPath.f56y;
    ...
    */
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f55x - this.mStartMotionPath.f55x;
        float dTop = this.mEndMotionPath.f56y - this.mStartMotionPath.f56y;
