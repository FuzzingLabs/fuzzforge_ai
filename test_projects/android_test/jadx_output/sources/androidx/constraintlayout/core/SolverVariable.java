...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    private static String getUniqueName(Type type, String prefix) {
        ...
        switch (C01691.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()]) {
            case 1:
    ...
    public void setSynonym(LinearSystem system, SolverVariable synonymVariable, float value) {
        this.isSynonym = true;
        this.synonym = synonymVariable.f15id;
