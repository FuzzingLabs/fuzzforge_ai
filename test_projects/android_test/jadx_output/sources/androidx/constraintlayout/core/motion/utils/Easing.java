...
public class Easing {
    ...
    static class CubicEasing extends Easing {
        ...
        CubicEasing(String configString) {
            ...
            this.f22x1 = Double.parseDouble(configString.substring(start + 1, off1).trim());
            int off2 = configString.indexOf(44, off1 + 1);
            this.f24y1 = Double.parseDouble(configString.substring(off1 + 1, off2).trim());
            int off3 = configString.indexOf(44, off2 + 1);
            this.f23x2 = Double.parseDouble(configString.substring(off2 + 1, off3).trim());
            int end = configString.indexOf(41, off3 + 1);
            this.f25y2 = Double.parseDouble(configString.substring(off3 + 1, end).trim());
        }
        ...
        private double getX(double t) {
            ...
            double f3 = t * t * t;
            return (this.f22x1 * f1) + (this.f23x2 * f2) + f3;
        }
        ...
        private double getY(double t) {
            ...
            double f2 = 3.0d * t1 * t * t;
            double f3 = t * t * t;
            return (this.f24y1 * f1) + (this.f25y2 * f2) + f3;
        }

        private double getDiffX(double t) {
            double t1 = 1.0d - t;
            double d = this.f22x1;
            double d2 = this.f23x2;
