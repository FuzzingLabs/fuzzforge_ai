    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        if (i3 >= 0 && i3 < 4) {
            ...
            if (this.resolved) {
                ...
                if (i4 == 0 || i4 == 1) {
                    system.addEquality(this.mLeft.mSolverVariable, this.f40mX);
                    system.addEquality(this.mRight.mSolverVariable, this.f40mX);
                    return;
                } else {
                    if (i4 == 2 || i4 == 3) {
                        system.addEquality(this.mTop.mSolverVariable, this.f41mY);
                        system.addEquality(this.mBottom.mSolverVariable, this.f41mY);
                        return;
                    }
                    return;
                }
