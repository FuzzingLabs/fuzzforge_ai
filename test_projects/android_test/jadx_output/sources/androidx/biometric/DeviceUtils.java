...
class DeviceUtils {
    ...
    public static boolean shouldUseFingerprintForCrypto(Context context, String vendor, String model) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean shouldHideFingerprintDialog(Context context, String model) {
        if (Build.VERSION.SDK_INT != 28) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean shouldDelayShowingPrompt(Context context, String model) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean canAssumeStrongBiometrics(Context context, String model) {
