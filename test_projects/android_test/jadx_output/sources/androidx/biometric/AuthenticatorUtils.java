...
class AuthenticatorUtils {
    ...
    public static String convertToString(int authenticators) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getConsolidatedAuthenticators(BiometricPrompt.PromptInfo info, BiometricPrompt.CryptoObject crypto) {
        int authenticators;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isSupportedCombination(int authenticators) {
        switch (authenticators) {
            case 15:
            case 255:
            case 33023:
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isDeviceCredentialAllowed(int authenticators) {
        return (32768 & authenticators) != 0;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isSomeBiometricAllowed(int authenticators) {
        return (authenticators & BIOMETRIC_CLASS_MASK) != 0;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isWeakBiometricAllowed(int authenticators) {
