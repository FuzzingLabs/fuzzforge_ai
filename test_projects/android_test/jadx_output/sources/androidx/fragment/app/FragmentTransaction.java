...
public abstract class FragmentTransaction {
    ...
    /* loaded from: classes.dex */
    public static final class C0355Op {
        int mCmd;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public C0355Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        C0355Op(int cmd, Fragment fragment, Lifecycle.State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0355Op(opcmd, fragment));
    }
