...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0304R.styleable.Fragment);
        if (fname == null) {
            fname = a.getString(C0304R.styleable.Fragment_android_name);
        }
        int id = a.getResourceId(C0304R.styleable.Fragment_android_id, -1);
        String tag = a.getString(C0304R.styleable.Fragment_android_tag);
        a.recycle();
