...
public class FragmentAnim {
    ...
    public static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean enter, boolean isPop) {
        ...
        if (fragment.mContainer != null && fragment.mContainer.getTag(C0304R.id.visible_removing_fragment_view_tag) != null) {
            fragment.mContainer.setTag(C0304R.id.visible_removing_fragment_view_tag, null);
        }
    ...
    private static int transitToAnimResourceId(int transit, boolean enter) {
        switch (transit) {
            case FragmentTransaction.TRANSIT_FRAGMENT_OPEN /* 4097 */:
                int animAttr = enter ? C0304R.animator.fragment_open_enter : C0304R.animator.fragment_open_exit;
                return animAttr;
            case FragmentTransaction.TRANSIT_FRAGMENT_FADE /* 4099 */:
                int animAttr2 = enter ? C0304R.animator.fragment_fade_enter : C0304R.animator.fragment_fade_exit;
                return animAttr2;
            case 8194:
                int animAttr3 = enter ? C0304R.animator.fragment_close_enter : C0304R.animator.fragment_close_exit;
                return animAttr3;
            default:
                return -1;
        }
