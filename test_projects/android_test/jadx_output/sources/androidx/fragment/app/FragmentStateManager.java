...
public class FragmentStateManager {
    ...
    public int computeExpectedState() {
        ...
        switch (C03532.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()]) {
            case 1:
                break;
            case 2:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C03532 {
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0304R.id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
