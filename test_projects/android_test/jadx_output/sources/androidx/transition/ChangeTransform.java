...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (this.mReparent) {
            ...
            transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0518R.id.transition_transform));
            transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0518R.id.parent_matrix));
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, final boolean handleParentChange) {
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() { // from class: androidx.transition.ChangeTransform.3
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (handleParentChange && ChangeTransform.this.mUseOverlay) {
                        ...
                        view.setTag(C0518R.id.transition_transform, null);
                        view.setTag(C0518R.id.parent_matrix, null);
                    }
                }
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view.setTag(C0518R.id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0518R.id.parent_matrix, endParentMatrix);
    ...
    public static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTag(C0518R.id.transition_transform, null);
            this.mView.setTag(C0518R.id.parent_matrix, null);
        }
