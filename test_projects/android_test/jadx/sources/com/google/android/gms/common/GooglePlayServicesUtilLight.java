...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C0688R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        if (PlatformVersion.isAtLeastJellyBeanMR2() && (applicationRestrictions = ((UserManager) context.getSystemService(UserSignUp.MyPREFERENCES)).getApplicationRestrictions(context.getPackageName())) != null && "true".equals(applicationRestrictions.getString("restricted_profile"))) {
            return true;
        }
        return false;
    }
