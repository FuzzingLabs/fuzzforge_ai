...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C0690R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C0690R.layout.design_bottom_sheet_dialog, null);
            this.container = frameLayout;
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(C0690R.id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C0690R.id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinator = (CoordinatorLayout) this.container.findViewById(C0690R.id.coordinator);
        ...
        coordinator.findViewById(C0690R.id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
    ...
    private static int getThemeResId(Context context, int themeId) {
        if (themeId == 0) {
            ...
            if (context.getTheme().resolveAttribute(C0690R.attr.bottomSheetDialogTheme, outValue, true)) {
                return outValue.resourceId;
            }
            return C0690R.style.Theme_Design_Light_BottomSheetDialog;
        }
        return themeId;
    }
