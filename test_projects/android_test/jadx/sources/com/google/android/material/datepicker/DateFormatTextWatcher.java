...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    DateFormatTextWatcher(final String formatHint, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints constraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C0690R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher.1
            ...
            public void run() {
                ...
                String invalidFormat = context.getString(C0690R.string.mtrl_picker_invalid_format);
                String useLine = String.format(context.getString(C0690R.string.mtrl_picker_invalid_format_use), formatHint);
                String exampleLine = String.format(context.getString(C0690R.string.mtrl_picker_invalid_format_example), df.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())));
