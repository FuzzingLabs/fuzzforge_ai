...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        float popupCornerRadius = this.context.getResources().getDimensionPixelOffset(C0690R.dimen.mtrl_shape_corner_size_small_component);
        float exposedDropdownPopupElevation = this.context.getResources().getDimensionPixelOffset(C0690R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int exposedDropdownPopupVerticalPadding = this.context.getResources().getDimensionPixelOffset(C0690R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        int drawableResId = IS_LOLLIPOP ? C0690R.drawable.mtrl_dropdown_arrow : C0690R.drawable.mtrl_ic_arrow_drop_down;
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, drawableResId));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0690R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView editText) {
        ...
        int rippleColor = MaterialColors.getColor(editText, C0690R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView editText, int rippleColor, int[][] states, MaterialShapeDrawable boxBackground) {
        ...
        int surfaceColor = MaterialColors.getColor(editText, C0690R.attr.colorSurface);
