...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private static final int DEF_STYLE_RES = C0690R.style.Widget_Design_CollapsingToolbar;
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0690R.attr.collapsingToolbarLayoutStyle);
    }
    ...
    */
    ...
    static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper offsetHelper = (ViewOffsetHelper) view.getTag(C0690R.id.view_offset_helper);
        if (offsetHelper == null) {
            ViewOffsetHelper offsetHelper2 = new ViewOffsetHelper(view);
            view.setTag(C0690R.id.view_offset_helper, offsetHelper2);
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, C0690R.styleable.CollapsingToolbarLayout_Layout);
            this.collapseMode = a.getInt(C0690R.styleable.CollapsingToolbarLayout_Layout_layout_collapseMode, 0);
            setParallaxMultiplier(a.getFloat(C0690R.styleable.CollapsingToolbarLayout_Layout_layout_collapseParallaxMultiplier, 0.5f));
            a.recycle();
        }
