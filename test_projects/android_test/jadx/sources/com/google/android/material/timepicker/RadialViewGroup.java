...
class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0690R.layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray a = context.obtainStyledAttributes(attrs, C0690R.styleable.RadialViewGroup, defStyleAttr, 0);
        this.radius = a.getDimensionPixelSize(C0690R.styleable.RadialViewGroup_materialCircleRadius, 0);
    ...
    protected void updateLayoutParams() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childAt.getId() != C0690R.id.circle_center && !shouldSkipView(childAt)) {
                constraintSet.constrainCircle(childAt.getId(), C0690R.id.circle_center, this.radius, currentAngle);
