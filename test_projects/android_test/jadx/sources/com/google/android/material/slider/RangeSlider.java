...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public RangeSlider(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0690R.styleable.RangeSlider, defStyleAttr, DEF_STYLE_RES, new int[0]);
        if (a.hasValue(C0690R.styleable.RangeSlider_values)) {
            int valuesId = a.getResourceId(C0690R.styleable.RangeSlider_values, 0);
            TypedArray values = a.getResources().obtainTypedArray(valuesId);
            setValues(convertToFloat(values));
        }
        int valuesId2 = C0690R.styleable.RangeSlider_minSeparation;
