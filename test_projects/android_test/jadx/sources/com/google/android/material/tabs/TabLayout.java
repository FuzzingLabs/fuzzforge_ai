...
public class TabLayout extends HorizontalScrollView {
    ...
    ViewPager viewPager;
    private static final int DEF_STYLE_RES = C0690R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0690R.attr.tabStyle);
    }
    ...
    */
    ...
    public final class TabView extends LinearLayout {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0690R.layout.design_layout_tab_icon, (ViewGroup) iconViewParent, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0690R.layout.design_layout_tab_text, (ViewGroup) textViewParent, false);
