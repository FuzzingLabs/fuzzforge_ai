...
class DaysOfWeekAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            dayOfWeek = (TextView) layoutInflater.inflate(C0690R.layout.mtrl_calendar_day_of_week, parent, false);
        }
        ...
        dayOfWeek.setContentDescription(String.format(parent.getContext().getString(C0690R.string.mtrl_picker_day_of_week_column_header), this.calendar.getDisplayName(7, 2, Locale.getDefault())));
        return dayOfWeek;
    }
