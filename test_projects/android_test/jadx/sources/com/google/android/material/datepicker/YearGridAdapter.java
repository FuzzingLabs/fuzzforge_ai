...
class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        TextView yearTextView = (TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C0690R.layout.mtrl_calendar_year, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        String navigateYear = viewHolder.textView.getContext().getString(C0690R.string.mtrl_picker_navigate_to_year_description);
