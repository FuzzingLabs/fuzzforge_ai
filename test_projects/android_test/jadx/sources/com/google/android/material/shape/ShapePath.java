...
public class ShapePath {
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            float height = this.operation.f146y - this.startY;
            float width = this.operation.f145x - this.startX;
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f146y - this.startY) / (this.operation.f145x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix transform, Path path) {
            ...
            path.lineTo(this.f145x, this.f146y);
