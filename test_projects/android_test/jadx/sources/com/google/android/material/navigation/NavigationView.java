...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    private static final int DEF_STYLE_RES = C0690R.style.Widget_Design_NavigationView;
    ...
    public NavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, C0690R.attr.navigationViewStyle);
    }
    ...
    */
    ...
    private boolean hasShapeAppearance(TintTypedArray a) {
        return a.hasValue(C0690R.styleable.NavigationView_itemShapeAppearance) || a.hasValue(C0690R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private final Drawable createDefaultItemBackground(TintTypedArray a) {
        int shapeAppearanceResId = a.getResourceId(C0690R.styleable.NavigationView_itemShapeAppearance, 0);
        int shapeAppearanceOverlayResId = a.getResourceId(C0690R.styleable.NavigationView_itemShapeAppearanceOverlay, 0);
        ...
        materialShapeDrawable.setFillColor(MaterialResources.getColorStateList(getContext(), a, C0690R.styleable.NavigationView_itemShapeFillColor));
        int insetLeft = a.getDimensionPixelSize(C0690R.styleable.NavigationView_itemShapeInsetStart, 0);
        int insetTop = a.getDimensionPixelSize(C0690R.styleable.NavigationView_itemShapeInsetTop, 0);
        int insetRight = a.getDimensionPixelSize(C0690R.styleable.NavigationView_itemShapeInsetEnd, 0);
        int insetBottom = a.getDimensionPixelSize(C0690R.styleable.NavigationView_itemShapeInsetBottom, 0);
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0046R.attr.colorPrimary, value, true)) {
            return null;
        }
