...
class UtcDates {
    ...
    static String getTextInputHint(Resources res, SimpleDateFormat format) {
        ...
        String yearChar = res.getString(C0690R.string.mtrl_picker_text_input_year_abbr);
        String monthChar = res.getString(C0690R.string.mtrl_picker_text_input_month_abbr);
        String dayChar = res.getString(C0690R.string.mtrl_picker_text_input_day_abbr);
