...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View viewOverride, int viewIdOverride, ShapeAppearanceModel shapeAppearanceModelOverride) {
        ...
        } else if (transitionValues.view.getTag(C0690R.id.mtrl_motion_snapshot_view) instanceof View) {
            View snapshotView = (View) transitionValues.view.getTag(C0690R.id.mtrl_motion_snapshot_view);
            transitionValues.view.setTag(C0690R.id.mtrl_motion_snapshot_view, null);
    ...
    private static ShapeAppearanceModel getShapeAppearance(View view, ShapeAppearanceModel shapeAppearanceModelOverride) {
        ...
        if (view.getTag(C0690R.id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C0690R.id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray a = context.obtainStyledAttributes(new int[]{C0690R.attr.transitionShapeAppearance});
    ...
    private void maybeApplyThemeValues(Context context, boolean entering) {
        TransitionUtils.maybeApplyThemeInterpolator(this, context, C0690R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        TransitionUtils.maybeApplyThemeDuration(this, context, entering ? C0690R.attr.motionDurationLong1 : C0690R.attr.motionDurationMedium2);
        if (!this.pathMotionCustom) {
            TransitionUtils.maybeApplyThemePath(this, context, C0690R.attr.motionPath);
        }
    }
