...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0690R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0690R.attr.snackbarButtonStyle, C0690R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) inflater.inflate(hasSnackbarContentStyleAttrs(context) ? C0690R.layout.mtrl_layout_snackbar_include : C0690R.layout.design_layout_snackbar_include, parent, false);
