...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m73of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m74of(Range.all()));
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m114of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m115of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m74of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.size() == 1 && this.ranges.get(0).equals(Range.all())) {
            ImmutableRangeSet<C> m114of = m114of();
            this.complement = m114of;
            return m114of;
        }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> domain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m154of();
        }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m74of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
