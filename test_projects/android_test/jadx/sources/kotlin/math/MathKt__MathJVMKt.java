...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m256ln(double x) {
        return Math.log(x);
    }
    ...
    /* renamed from: ln */
    private static final float m257ln(float x) {
