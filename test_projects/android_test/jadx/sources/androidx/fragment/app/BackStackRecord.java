    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                FragmentTransaction.C0355Op op = this.mOps.get(opNum);
                switch (op.mCmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
            ...
            if (container != 0 && container != lastContainer) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        FragmentTransaction.C0355Op thatOp = record.mOps.get(thoseOpIndex);
            ...
            switch (op.mCmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new FragmentTransaction.C0355Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                FragmentTransaction.C0355Op removeOp = new FragmentTransaction.C0355Op(3, old);
                ...
                case 6:
                    ...
                    if (op.mFragment == oldPrimaryNav) {
                        this.mOps.add(opNum, new FragmentTransaction.C0355Op(9, op.mFragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    } else {
                ...
                case 8:
                    this.mOps.add(opNum, new FragmentTransaction.C0355Op(9, oldPrimaryNav));
                    opNum++;
