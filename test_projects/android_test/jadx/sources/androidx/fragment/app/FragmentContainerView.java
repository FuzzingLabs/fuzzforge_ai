...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0304R.styleable.FragmentContainerView);
            if (name == null) {
                name = a.getString(C0304R.styleable.FragmentContainerView_android_name);
    ...
    FragmentContainerView(Context context, AttributeSet attrs, FragmentManager fm) {
        ...
        String name = attrs.getClassAttribute();
        TypedArray a = context.obtainStyledAttributes(attrs, C0304R.styleable.FragmentContainerView);
        name = name == null ? a.getString(C0304R.styleable.FragmentContainerView_android_name) : name;
        String tag = a.getString(C0304R.styleable.FragmentContainerView_android_tag);
        a.recycle();
        int id = getId();
