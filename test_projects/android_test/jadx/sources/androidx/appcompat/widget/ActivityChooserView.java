...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0046R.styleable.ActivityChooserView, attrs, attributesArray, defStyle, 0);
        ...
        inflater.inflate(C0046R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        ...
        FrameLayout expandButton = (FrameLayout) findViewById(C0046R.id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0046R.id.image);
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (itemViewType) {
                case 0:
                    if (convertView == null || convertView.getId() != C0046R.id.list_item) {
                    ...
                    ImageView iconView = (ImageView) convertView.findViewById(C0046R.id.icon);
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    iconView.setImageDrawable(activity.loadIcon(packageManager));
                    TextView titleView = (TextView) convertView.findViewById(C0046R.id.title);
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        ...
                        TextView titleView2 = (TextView) convertView2.findViewById(C0046R.id.title);
                        titleView2.setText(ActivityChooserView.this.getContext().getString(C0046R.string.abc_activity_chooser_view_see_all));
                        return convertView2;
                    }
                    return convertView;
                default:
