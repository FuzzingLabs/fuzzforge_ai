...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int layoutResId = a.getResourceId(C0046R.styleable.SearchView_layout, C0046R.layout.abc_search_view);
        ...
        ViewCompat.setBackground(findViewById, a.getDrawable(C0046R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, a.getDrawable(C0046R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(a.getDrawable(C0046R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(a.getDrawable(C0046R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(a.getDrawable(C0046R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(a.getDrawable(C0046R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(a.getDrawable(C0046R.styleable.SearchView_searchIcon));
        ...
        boolean focusable = a.getBoolean(C0046R.styleable.SearchView_android_focusable, true);
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                iconOffset = res.getDimensionPixelSize(C0046R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0046R.dimen.abc_dropdownitem_text_padding_left);
            } else {
                iconOffset = 0;
            }
