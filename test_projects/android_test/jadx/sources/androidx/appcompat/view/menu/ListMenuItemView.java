...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray b = context.getTheme().obtainStyledAttributes(null, new int[]{R.attr.divider}, C0046R.attr.dropDownListViewStyle, 0);
    ...
    private void insertIconView() {
        ...
        ImageView imageView = (ImageView) inflater.inflate(C0046R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
    ...
    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        RadioButton radioButton = (RadioButton) inflater.inflate(C0046R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
    ...
    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        CheckBox checkBox = (CheckBox) inflater.inflate(C0046R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
