...
import androidx.recyclerview.C0433R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C0433R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0433R.styleable.RecyclerView, defStyleAttr, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0433R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C0433R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C0433R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C0433R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = a.getBoolean(C0433R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            StateListDrawable verticalThumbDrawable = (StateListDrawable) a.getDrawable(C0433R.styleable.RecyclerView_fastScrollVerticalThumbDrawable);
            Drawable verticalTrackDrawable = a.getDrawable(C0433R.styleable.RecyclerView_fastScrollVerticalTrackDrawable);
            StateListDrawable horizontalThumbDrawable = (StateListDrawable) a.getDrawable(C0433R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable);
            Drawable horizontalTrackDrawable = a.getDrawable(C0433R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable);
    ...
    */
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            properties.orientation = a.getInt(C0433R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0433R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0433R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0433R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
