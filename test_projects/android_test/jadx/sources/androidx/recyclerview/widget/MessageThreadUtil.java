...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C04591 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem msg = C04591.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case 1:
                            C04591.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case 2:
                            TileList.Tile<T> tile = (TileList.Tile) msg.data;
                            C04591.this.val$callback.addTile(msg.arg1, tile);
                            break;
                        case 3:
                            C04591.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C04591.this.mQueue.next();
                }
            }
        };

        C04591(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> callback) {
        return new C04591(callback);
    }

    /* renamed from: androidx.recyclerview.widget.MessageThreadUtil$2 */
    class C04602 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C04602.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case 1:
                                C04602.this.mQueue.removeMessages(1);
                                C04602.this.val$callback.refresh(msg.arg1);
                                break;
                            case 2:
                                C04602.this.mQueue.removeMessages(2);
                                C04602.this.mQueue.removeMessages(3);
                                C04602.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case 3:
                                C04602.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case 4:
                                TileList.Tile<T> tile = (TileList.Tile) msg.data;
                                C04602.this.val$callback.recycleTile(tile);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                        ...
                        C04602.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C04602(ThreadUtil.BackgroundCallback backgroundCallback) {
