...
public final class NotificationManagerCompat {
    ...
    private static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel service) throws RemoteException {
            service.notify(this.packageName, this.f65id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f65id + ", tag:" + this.tag + "]";
        }
    }
    ...
    private static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel service) throws RemoteException {
            if (this.all) {
                ...
                service.cancel(this.packageName, this.f64id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f64id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
}
