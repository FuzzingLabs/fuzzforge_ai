...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0212R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0212R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0212R.drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0212R.id.notification_main_column);
            outerView.addView(C0212R.id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0212R.id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0212R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0212R.id.title, 8);
            outerView.setViewVisibility(C0212R.id.text2, 8);
            outerView.setViewVisibility(C0212R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0212R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0212R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C0212R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0212R.id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0212R.id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0212R.id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0212R.id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0212R.layout.notification_action_tombstone : C0212R.layout.notification_action);
            IconCompat icon = action.getIconCompat();
            if (icon != null) {
                button.setImageViewBitmap(C0212R.id.action_image, createColoredBitmap(icon, this.mBuilder.mContext.getResources().getColor(C0212R.color.notification_action_color_filter)));
            }
            button.setTextViewText(C0212R.id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0212R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0212R.id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m279clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m280clone() {
            WearableExtender that = new WearableExtender();
