...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        Cursor cursor = null;
        try {
            String[] projection = {DatabaseHelper._ID, FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE};
            int ttcIndex = 1;
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                int weight = cursor.getColumnIndex(DatabaseHelper._ID);
