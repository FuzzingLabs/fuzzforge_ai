...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View host, int action, Bundle args) {
        ...
        if (!success && action == C0212R.id.accessibility_action_clickable_span) {
    ...
    private boolean performClickableSpanAction(int clickableSpanId, View host) {
        ...
        SparseArray<WeakReference<ClickableSpan>> spans = (SparseArray) host.getTag(C0212R.id.tag_accessibility_clickable_spans);
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (List) view.getTag(C0212R.id.tag_accessibility_actions);
