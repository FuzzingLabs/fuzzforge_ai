...
public class Motion {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f20x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f21y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f20x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f21y;
    }
    ...
    MotionKeyPosition getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f20x;
        start.top = this.mStartMotionPath.f21y;
        ...
        end.left = this.mEndMotionPath.f20x;
        end.top = this.mEndMotionPath.f21y;
    ...
    float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f20x - this.mStartMotionPath.f20x;
        float dy = this.mEndMotionPath.f21y - this.mStartMotionPath.f21y;
        float startCenterX = this.mStartMotionPath.f20x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f21y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (points[0].mPathMotionArc != -1) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                values[i10][0] = points[i10].f20x;
                values[i10][1] = points[i10].f21y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f20x + " y: " + this.mStartMotionPath.f21y + " end: x: " + this.mEndMotionPath.f20x + " y: " + this.mEndMotionPath.f21y;
    }
            ...
            case -1:
                ...
                return new DifferentialInterpolator() { // from class: androidx.constraintlayout.core.motion.Motion.1
                    ...
                    public float getVelocity() {
                        return (float) Easing.this.getDiff(this.f17mX);
                    }
                };
            default:
                return null;
    ...
    public boolean interpolate(MotionWidget child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f20x + ((this.mEndMotionPath.f20x - this.mStartMotionPath.f20x) * position);
            float float_t = this.mStartMotionPath.f21y + ((this.mEndMotionPath.f21y - this.mStartMotionPath.f21y) * position);
    ...
    void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f20x - this.mStartMotionPath.f20x;
        float dTop = this.mEndMotionPath.f21y - this.mStartMotionPath.f21y;
