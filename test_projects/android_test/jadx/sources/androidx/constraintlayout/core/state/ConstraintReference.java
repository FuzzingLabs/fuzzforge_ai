    ...
    */
    public androidx.constraintlayout.core.state.ConstraintReference bias(float r3) {
        /*
            ...
            return r2
        L5:
            int[] r0 = androidx.constraintlayout.core.state.ConstraintReference.C01751.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint
    ...
    private void applyConnection(ConstraintWidget widget, Object opaqueTarget, State.Constraint type) {
        ...
        int i = C01751.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()];
        switch (C01751.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()]) {
            case 1:
