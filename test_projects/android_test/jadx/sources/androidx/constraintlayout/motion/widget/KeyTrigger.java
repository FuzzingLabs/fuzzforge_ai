...
public class KeyTrigger extends Key {
    ...
    public void load(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0208R.styleable.KeyTrigger);
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0208R.styleable.KeyTrigger_framePosition, 8);
            mAttrMap.append(C0208R.styleable.KeyTrigger_onCross, 4);
            mAttrMap.append(C0208R.styleable.KeyTrigger_onNegativeCross, 1);
            mAttrMap.append(C0208R.styleable.KeyTrigger_onPositiveCross, 2);
            mAttrMap.append(C0208R.styleable.KeyTrigger_motionTarget, 7);
            mAttrMap.append(C0208R.styleable.KeyTrigger_triggerId, 6);
            mAttrMap.append(C0208R.styleable.KeyTrigger_triggerSlack, 5);
            mAttrMap.append(C0208R.styleable.KeyTrigger_motion_triggerOnCollision, 9);
            mAttrMap.append(C0208R.styleable.KeyTrigger_motion_postLayoutCollision, 10);
            mAttrMap.append(C0208R.styleable.KeyTrigger_triggerReceiver, 11);
            mAttrMap.append(C0208R.styleable.KeyTrigger_viewTransitionOnCross, 12);
            mAttrMap.append(C0208R.styleable.KeyTrigger_viewTransitionOnNegativeCross, 13);
            mAttrMap.append(C0208R.styleable.KeyTrigger_viewTransitionOnPositiveCross, 14);
        }
