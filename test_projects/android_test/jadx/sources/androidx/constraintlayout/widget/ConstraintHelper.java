...
public abstract class ConstraintHelper extends View {
    ...
    protected void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0208R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = a.getString(attr);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (attr == C0208R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(String referenceId) {
        ...
        if (rscId == 0) {
            try {
                Field field = C0208R.id.class.getField(referenceId);
