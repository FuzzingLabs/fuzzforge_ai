...
import androidx.constraintlayout.widget.C0208R;
...
public class ConstraintSet {
    ...
    static {
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintBaseline_toTopOf, 91);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintBaseline_toBottomOf, 92);
        mapToConstant.append(C0208R.styleable.Constraint_layout_editor_absoluteX, 6);
        mapToConstant.append(C0208R.styleable.Constraint_layout_editor_absoluteY, 7);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintGuide_begin, 17);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintGuide_end, 18);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintGuide_percent, 19);
        mapToConstant.append(C0208R.styleable.Constraint_android_orientation, 27);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C0208R.styleable.Constraint_layout_goneMarginLeft, 13);
        mapToConstant.append(C0208R.styleable.Constraint_layout_goneMarginTop, 16);
        mapToConstant.append(C0208R.styleable.Constraint_layout_goneMarginRight, 14);
        mapToConstant.append(C0208R.styleable.Constraint_layout_goneMarginBottom, 11);
        mapToConstant.append(C0208R.styleable.Constraint_layout_goneMarginStart, 15);
        mapToConstant.append(C0208R.styleable.Constraint_layout_goneMarginEnd, 12);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintVertical_weight, 40);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintVertical_bias, 37);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintLeft_creator, 87);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintTop_creator, 87);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintRight_creator, 87);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintBottom_creator, 87);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintBaseline_creator, 87);
        mapToConstant.append(C0208R.styleable.Constraint_android_layout_marginLeft, 24);
        mapToConstant.append(C0208R.styleable.Constraint_android_layout_marginRight, 28);
        mapToConstant.append(C0208R.styleable.Constraint_android_layout_marginStart, 31);
        mapToConstant.append(C0208R.styleable.Constraint_android_layout_marginEnd, 8);
        mapToConstant.append(C0208R.styleable.Constraint_android_layout_marginTop, 34);
        mapToConstant.append(C0208R.styleable.Constraint_android_layout_marginBottom, 2);
        mapToConstant.append(C0208R.styleable.Constraint_android_layout_width, 23);
        mapToConstant.append(C0208R.styleable.Constraint_android_layout_height, 21);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintWidth, 95);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintHeight, 96);
        mapToConstant.append(C0208R.styleable.Constraint_android_visibility, 22);
        mapToConstant.append(C0208R.styleable.Constraint_android_alpha, 43);
        mapToConstant.append(C0208R.styleable.Constraint_android_elevation, 44);
        mapToConstant.append(C0208R.styleable.Constraint_android_rotationX, 45);
        mapToConstant.append(C0208R.styleable.Constraint_android_rotationY, 46);
        mapToConstant.append(C0208R.styleable.Constraint_android_rotation, 60);
        mapToConstant.append(C0208R.styleable.Constraint_android_scaleX, 47);
        mapToConstant.append(C0208R.styleable.Constraint_android_scaleY, 48);
        mapToConstant.append(C0208R.styleable.Constraint_android_transformPivotX, 49);
        mapToConstant.append(C0208R.styleable.Constraint_android_transformPivotY, 50);
        mapToConstant.append(C0208R.styleable.Constraint_android_translationX, 51);
        mapToConstant.append(C0208R.styleable.Constraint_android_translationY, 52);
        mapToConstant.append(C0208R.styleable.Constraint_android_translationZ, 53);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintWidth_default, 54);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintHeight_default, 55);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintWidth_max, 56);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintHeight_max, 57);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintWidth_min, 58);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintHeight_min, 59);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0208R.styleable.Constraint_animateRelativeTo, 64);
        mapToConstant.append(C0208R.styleable.Constraint_transitionEasing, 65);
        mapToConstant.append(C0208R.styleable.Constraint_drawPath, 66);
        mapToConstant.append(C0208R.styleable.Constraint_transitionPathRotate, 67);
        mapToConstant.append(C0208R.styleable.Constraint_motionStagger, 79);
        mapToConstant.append(C0208R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0208R.styleable.Constraint_motionProgress, 68);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0208R.styleable.Constraint_layout_wrapBehaviorInParent, 97);
        mapToConstant.append(C0208R.styleable.Constraint_chainUseRtl, 71);
        mapToConstant.append(C0208R.styleable.Constraint_barrierDirection, 72);
        mapToConstant.append(C0208R.styleable.Constraint_barrierMargin, 73);
        mapToConstant.append(C0208R.styleable.Constraint_constraint_referenced_ids, 74);
        mapToConstant.append(C0208R.styleable.Constraint_barrierAllowsGoneWidgets, 75);
        mapToConstant.append(C0208R.styleable.Constraint_pathMotionArc, 76);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constraintTag, 77);
        mapToConstant.append(C0208R.styleable.Constraint_visibilityMode, 78);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constrainedWidth, 80);
        mapToConstant.append(C0208R.styleable.Constraint_layout_constrainedHeight, 81);
        mapToConstant.append(C0208R.styleable.Constraint_polarRelativeTo, 82);
        mapToConstant.append(C0208R.styleable.Constraint_transformPivotTarget, 83);
        mapToConstant.append(C0208R.styleable.Constraint_quantizeMotionSteps, 84);
        mapToConstant.append(C0208R.styleable.Constraint_quantizeMotionPhase, 85);
        mapToConstant.append(C0208R.styleable.Constraint_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_editor_absoluteY, 6);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_editor_absoluteY, 7);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_orientation, 27);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_goneMarginLeft, 13);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_goneMarginTop, 16);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_goneMarginRight, 14);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_goneMarginBottom, 11);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_goneMarginStart, 15);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_goneMarginEnd, 12);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintVertical_weight, 40);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintHorizontal_weight, 39);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintHorizontal_chainStyle, 41);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintVertical_chainStyle, 42);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintHorizontal_bias, 20);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintVertical_bias, 37);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintDimensionRatio, 5);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintLeft_creator, 87);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintTop_creator, 87);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintRight_creator, 87);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintBottom_creator, 87);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintBaseline_creator, 87);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_layout_marginLeft, 24);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_layout_marginRight, 28);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_layout_marginStart, 31);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_layout_marginEnd, 8);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_layout_marginTop, 34);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_layout_marginBottom, 2);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_layout_width, 23);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_layout_height, 21);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintWidth, 95);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintHeight, 96);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_visibility, 22);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_alpha, 43);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_elevation, 44);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_rotationX, 45);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_rotationY, 46);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_rotation, 60);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_scaleX, 47);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_scaleY, 48);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_transformPivotX, 49);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_transformPivotY, 50);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_translationX, 51);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_translationY, 52);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_translationZ, 53);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintWidth_default, 54);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintHeight_default, 55);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintWidth_max, 56);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintHeight_max, 57);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintWidth_min, 58);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintHeight_min, 59);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintCircleRadius, 62);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintCircleAngle, 63);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_animateRelativeTo, 64);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_transitionEasing, 65);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_drawPath, 66);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_transitionPathRotate, 67);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_motionStagger, 79);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_motionTarget, 98);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_motionProgress, 68);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintWidth_percent, 69);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintHeight_percent, 70);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_chainUseRtl, 71);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_barrierDirection, 72);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_barrierMargin, 73);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_constraint_referenced_ids, 74);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_barrierAllowsGoneWidgets, 75);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_pathMotionArc, 76);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constraintTag, 77);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_visibilityMode, 78);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constrainedWidth, 80);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_constrainedHeight, 81);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_polarRelativeTo, 82);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_transformPivotTarget, 83);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_quantizeMotionSteps, 84);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_quantizeMotionPhase, 85);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0208R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, 97);
    }
    ...
    public static class Layout {
        ...
        static {
            ...
            sparseIntArray.append(C0208R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            mapToConstant.append(C0208R.styleable.Layout_layout_editor_absoluteX, 6);
            mapToConstant.append(C0208R.styleable.Layout_layout_editor_absoluteY, 7);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintGuide_begin, 17);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintGuide_end, 18);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintGuide_percent, 19);
            mapToConstant.append(C0208R.styleable.Layout_android_orientation, 26);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            mapToConstant.append(C0208R.styleable.Layout_layout_goneMarginLeft, 13);
            mapToConstant.append(C0208R.styleable.Layout_layout_goneMarginTop, 16);
            mapToConstant.append(C0208R.styleable.Layout_layout_goneMarginRight, 14);
            mapToConstant.append(C0208R.styleable.Layout_layout_goneMarginBottom, 11);
            mapToConstant.append(C0208R.styleable.Layout_layout_goneMarginStart, 15);
            mapToConstant.append(C0208R.styleable.Layout_layout_goneMarginEnd, 12);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintVertical_weight, 38);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintVertical_bias, 36);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintDimensionRatio, 5);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintLeft_creator, 76);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintTop_creator, 76);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintRight_creator, 76);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintBottom_creator, 76);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintBaseline_creator, 76);
            mapToConstant.append(C0208R.styleable.Layout_android_layout_marginLeft, 23);
            mapToConstant.append(C0208R.styleable.Layout_android_layout_marginRight, 27);
            mapToConstant.append(C0208R.styleable.Layout_android_layout_marginStart, 30);
            mapToConstant.append(C0208R.styleable.Layout_android_layout_marginEnd, 8);
            mapToConstant.append(C0208R.styleable.Layout_android_layout_marginTop, 33);
            mapToConstant.append(C0208R.styleable.Layout_android_layout_marginBottom, 2);
            mapToConstant.append(C0208R.styleable.Layout_android_layout_width, 22);
            mapToConstant.append(C0208R.styleable.Layout_android_layout_height, 21);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintWidth, 41);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintHeight, 42);
            mapToConstant.append(C0208R.styleable.Layout_layout_constrainedWidth, 41);
            mapToConstant.append(C0208R.styleable.Layout_layout_constrainedHeight, 42);
            mapToConstant.append(C0208R.styleable.Layout_layout_wrapBehaviorInParent, 97);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintCircleRadius, 62);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintWidth_percent, 69);
            mapToConstant.append(C0208R.styleable.Layout_layout_constraintHeight_percent, 70);
            mapToConstant.append(C0208R.styleable.Layout_chainUseRtl, 71);
            mapToConstant.append(C0208R.styleable.Layout_barrierDirection, 72);
            mapToConstant.append(C0208R.styleable.Layout_barrierMargin, 73);
            mapToConstant.append(C0208R.styleable.Layout_constraint_referenced_ids, 74);
            mapToConstant.append(C0208R.styleable.Layout_barrierAllowsGoneWidgets, 75);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0208R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0208R.styleable.Transform_android_rotation, 1);
            mapToConstant.append(C0208R.styleable.Transform_android_rotationX, 2);
            mapToConstant.append(C0208R.styleable.Transform_android_rotationY, 3);
            mapToConstant.append(C0208R.styleable.Transform_android_scaleX, 4);
            mapToConstant.append(C0208R.styleable.Transform_android_scaleY, 5);
            mapToConstant.append(C0208R.styleable.Transform_android_transformPivotX, 6);
            mapToConstant.append(C0208R.styleable.Transform_android_transformPivotY, 7);
            mapToConstant.append(C0208R.styleable.Transform_android_translationX, 8);
            mapToConstant.append(C0208R.styleable.Transform_android_translationY, 9);
            mapToConstant.append(C0208R.styleable.Transform_android_translationZ, 10);
            mapToConstant.append(C0208R.styleable.Transform_android_elevation, 11);
            mapToConstant.append(C0208R.styleable.Transform_transformPivotTarget, 12);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0208R.styleable.Transform);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
    ...
    public static class PropertySet {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0208R.styleable.PropertySet);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0208R.styleable.PropertySet_android_alpha) {
                    this.alpha = a.getFloat(attr, this.alpha);
                } else if (attr == C0208R.styleable.PropertySet_android_visibility) {
                    this.visibility = a.getInt(attr, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (attr == C0208R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = a.getInt(attr, this.mVisibilityMode);
                } else if (attr == C0208R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0208R.styleable.Motion_motionPathRotate, 1);
            mapToConstant.append(C0208R.styleable.Motion_pathMotionArc, 2);
            mapToConstant.append(C0208R.styleable.Motion_transitionEasing, 3);
            mapToConstant.append(C0208R.styleable.Motion_drawPath, 4);
            mapToConstant.append(C0208R.styleable.Motion_animateRelativeTo, 5);
            mapToConstant.append(C0208R.styleable.Motion_animateCircleAngleTo, 6);
            mapToConstant.append(C0208R.styleable.Motion_motionStagger, 7);
            mapToConstant.append(C0208R.styleable.Motion_quantizeMotionSteps, 8);
            mapToConstant.append(C0208R.styleable.Motion_quantizeMotionPhase, 9);
            mapToConstant.append(C0208R.styleable.Motion_quantizeMotionInterpolator, 10);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0208R.styleable.Motion);
            this.mApply = true;
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            ...
            if (constraint != null) {
                this.mConstraints.put(key, constraint.m278clone());
            }
        }
    }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs, boolean override) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, override ? C0208R.styleable.ConstraintOverride : C0208R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser parser) {
        ...
        Constraint c = new Constraint();
        TypedArray a = context.obtainStyledAttributes(attrs, C0208R.styleable.ConstraintOverride);
    ...
    private void populateConstraint(Context ctx, Constraint c, TypedArray a, boolean override) {
        ...
        for (int i = 0; i < N; i++) {
            int attr = a.getIndex(i);
            if (attr != C0208R.styleable.Constraint_android_id && C0208R.styleable.Constraint_android_layout_marginStart != attr && C0208R.styleable.Constraint_android_layout_marginEnd != attr) {
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i < split.length) {
            ...
            int tag = 0;
            try {
                Field field = C0208R.id.class.getField(idString);
