...
class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(ViewGroup group, boolean suppress) {
        ...
        if (suppress) {
            ...
            if (layoutTransition2 != null) {
                ...
                if (layoutTransition2 != sEmptyLayoutTransition) {
                    group.setTag(C0518R.id.transition_layout_save, layoutTransition2);
                }
            }
        ...
        LayoutTransition layoutTransition3 = (LayoutTransition) group.getTag(C0518R.id.transition_layout_save);
        if (layoutTransition3 != null) {
            group.setTag(C0518R.id.transition_layout_save, null);
